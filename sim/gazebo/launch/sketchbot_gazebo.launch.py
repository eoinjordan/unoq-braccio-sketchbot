...
ARGUMENTS = [
    ...
    DeclareLaunchArgument("wrist_pen", default_value="0.163",
                         description="Wrist axis to pen tip, metres."),
    # Pen-down threshold, matching config/workspace.yaml pen.down_z_mm / up_z_mm.
    DeclareLaunchArgument("pen_down_z", default_value="-1.5"),
    DeclareLaunchArgument("pen_up_z", default_value="3.5"),
    DeclareLaunchArgument("paper_origin_x", default_value="0.220"),
    DeclareLaunchArgument("paper_origin_y", default_value="-0.015"),
    DeclareLaunchArgument("paper_width", default_value="0.030"),
    DeclareLaunchArgument("paper_height", default_value="0.030"),
